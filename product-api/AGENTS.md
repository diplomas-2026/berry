...
Login response should include token and current user identity fields needed by Android UI.
...
- provide enough records for meaningful Android app and UI test scenarios

---

# Test Users

On startup, API must create test users required for Android UI tests.
...
- File must stay machine-readable for Android test parsing.
